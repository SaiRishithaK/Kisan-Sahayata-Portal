...
public class DashboardFrame extends JFrame {
	...
	new MarketPriceThread().start();
        ...
        // Button Actions
        profileBtn.addActionListener(e -> {new ProfileFrame(farmer.getFarmerID()).setVisible(true); this.dispose(); });
        ...
        fertilizersBtn.addActionListener(e -> new FertilizerFrame().setVisible(true));

        cropsBtn.addActionListener(e ->
                new CropMainFrame(farmer).setVisible(true));
